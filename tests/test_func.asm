; ======================================
; Compilador C -> ASM
; Entrada: tests/test_c_simple_func.c
; ======================================

; Compilado desde: tests/test_c_simple_func.c
; ISA de 16 bits - Español/México
; NOTA: Definir main() al FINAL del archivo C para que sea el punto de entrada
